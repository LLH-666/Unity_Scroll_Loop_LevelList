...
public class UIAnimation : MonoBehaviour
{
    ...
    private bool Check()
    {
        switch (type)
        {
            ...
            case Type.Height:
                if (rectT == null)
                {
                    Debug.LogErrorFormat(
                        "[UIAnimation] Cannot play {0} animation on GameObject {1}: There is no RectTransform component.",
            ...
            case Type.Color:
                ...
                {
                    Debug.LogErrorFormat(
                        "[UIAnimation] Cannot play {0} animation on GameObject {1}: There is no Graphic component.",
                        type, gameObject.name);
                    return false;
                }
            ...
            case Type.Alpha:
                ...
                {
                    Debug.LogErrorFormat(
                        "[UIAnimation] Cannot play {0} animation on GameObject {1}: There is no CanvasGroup component.",
                        type, gameObject.name);
                    return false;
                }
    ...
    private void SetValue(object val)
    {
        switch (type)
        {
            ...
            case Type.Alpha:
                if (canvasGroup == null)
                {
                    Debug.LogError("Canvas Group Null: " + gameObject.name);
                }
    ...
    private static UIAnimation CreateAnimation(Type type, GameObject gameObject, bool useCurrentFrom, float from,
    ...
    private static UIAnimation CreateColorAnimation(GameObject gameObject, bool useCurrentFrom, Color from,
    ...
    private static UIAnimation CreateUIAnimation(GameObject gameObject, Type type, float duration,
        bool useCurrentFrom)
    {
